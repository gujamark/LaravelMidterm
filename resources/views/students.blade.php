        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <a href="{{ route('students.create') }}" class="btn btn-info add-new"><i class="fa fa-plus"></i> Add New</a>
                    </div>
                </div>
            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('students.store') }}" method="POST">
                                @csrf
                                <button class="add" title="Add" data-toggle="tooltip"><i class="material-icons">&#xE03B;</i></button>
                            </form>
                            <a href="{{ route('students.edit',['id'=>$student->id]) }}" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
